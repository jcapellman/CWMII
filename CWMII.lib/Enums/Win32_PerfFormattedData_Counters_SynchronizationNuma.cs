namespace CWMII.lib.Enums {
	public enum Win32_PerfFormattedData_Counters_SynchronizationNuma {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfFormattedData_Counters_SynchronizationNumaExtension {
		public static string GetWMIValue(this Win32_PerfFormattedData_Counters_SynchronizationNuma enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfFormattedData_Counters_SynchronizationNuma", enumOption.ToString());
	}
}