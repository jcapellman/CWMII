namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_PerfNet_Redirector {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_PerfNet_RedirectorExtension {
		public static string GetWMIValue(this Win32_PerfRawData_PerfNet_Redirector enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_PerfNet_Redirector", enumOption.ToString());
	}
}