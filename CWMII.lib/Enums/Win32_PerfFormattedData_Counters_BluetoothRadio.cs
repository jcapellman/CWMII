namespace CWMII.lib.Enums {
	public enum Win32_PerfFormattedData_Counters_BluetoothRadio {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfFormattedData_Counters_BluetoothRadioExtension {
		public static string GetWMIValue(this Win32_PerfFormattedData_Counters_BluetoothRadio enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfFormattedData_Counters_BluetoothRadio", enumOption.ToString());
	}
}