namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivityExtension {
		public static string GetWMIValue(this Win32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity", enumOption.ToString());
	}
}