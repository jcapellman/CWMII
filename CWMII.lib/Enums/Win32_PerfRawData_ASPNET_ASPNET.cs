namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_ASPNET_ASPNET {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_ASPNET_ASPNETExtension {
		public static string GetWMIValue(this Win32_PerfRawData_ASPNET_ASPNET enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_ASPNET_ASPNET", enumOption.ToString());
	}
}