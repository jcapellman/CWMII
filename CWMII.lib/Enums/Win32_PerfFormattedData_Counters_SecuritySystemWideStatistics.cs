namespace CWMII.lib.Enums {
	public enum Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfFormattedData_Counters_SecuritySystemWideStatisticsExtension {
		public static string GetWMIValue(this Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics", enumOption.ToString());
	}
}