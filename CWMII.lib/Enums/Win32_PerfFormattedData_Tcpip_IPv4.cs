namespace CWMII.lib.Enums {
	public enum Win32_PerfFormattedData_Tcpip_IPv4 {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfFormattedData_Tcpip_IPv4Extension {
		public static string GetWMIValue(this Win32_PerfFormattedData_Tcpip_IPv4 enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfFormattedData_Tcpip_IPv4", enumOption.ToString());
	}
}