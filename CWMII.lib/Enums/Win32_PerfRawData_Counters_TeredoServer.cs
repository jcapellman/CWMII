namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_Counters_TeredoServer {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_Counters_TeredoServerExtension {
		public static string GetWMIValue(this Win32_PerfRawData_Counters_TeredoServer enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_Counters_TeredoServer", enumOption.ToString());
	}
}