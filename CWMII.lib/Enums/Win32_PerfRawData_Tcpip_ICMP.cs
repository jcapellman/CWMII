namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_Tcpip_ICMP {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_Tcpip_ICMPExtension {
		public static string GetWMIValue(this Win32_PerfRawData_Tcpip_ICMP enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_Tcpip_ICMP", enumOption.ToString());
	}
}