namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_NvspPortStats_HyperVVirtualSwitchPort {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_NvspPortStats_HyperVVirtualSwitchPortExtension {
		public static string GetWMIValue(this Win32_PerfRawData_NvspPortStats_HyperVVirtualSwitchPort enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_NvspPortStats_HyperVVirtualSwitchPort", enumOption.ToString());
	}
}