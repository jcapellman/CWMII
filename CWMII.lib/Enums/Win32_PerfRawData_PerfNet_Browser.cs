namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_PerfNet_Browser {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_PerfNet_BrowserExtension {
		public static string GetWMIValue(this Win32_PerfRawData_PerfNet_Browser enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_PerfNet_Browser", enumOption.ToString());
	}
}