namespace CWMII.lib.Enums {
	public enum Win32_PerfFormattedData_Counters_TeredoRelay {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfFormattedData_Counters_TeredoRelayExtension {
		public static string GetWMIValue(this Win32_PerfFormattedData_Counters_TeredoRelay enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfFormattedData_Counters_TeredoRelay", enumOption.ToString());
	}
}