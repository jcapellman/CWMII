namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_WinNatCounters_WinNAT {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_WinNatCounters_WinNATExtension {
		public static string GetWMIValue(this Win32_PerfRawData_WinNatCounters_WinNAT enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_WinNatCounters_WinNAT", enumOption.ToString());
	}
}