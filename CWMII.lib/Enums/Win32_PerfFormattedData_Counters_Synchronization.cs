namespace CWMII.lib.Enums {
	public enum Win32_PerfFormattedData_Counters_Synchronization {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfFormattedData_Counters_SynchronizationExtension {
		public static string GetWMIValue(this Win32_PerfFormattedData_Counters_Synchronization enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfFormattedData_Counters_Synchronization", enumOption.ToString());
	}
}