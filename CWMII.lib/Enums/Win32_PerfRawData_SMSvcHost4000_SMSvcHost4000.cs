namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_SMSvcHost4000_SMSvcHost4000 {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_SMSvcHost4000_SMSvcHost4000Extension {
		public static string GetWMIValue(this Win32_PerfRawData_SMSvcHost4000_SMSvcHost4000 enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_SMSvcHost4000_SMSvcHost4000", enumOption.ToString());
	}
}