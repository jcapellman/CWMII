namespace CWMII.lib.Enums {
	...
	public static class Win32_PerfRawData_PerfOS_MemoryExtension {
		public static string GetWMIValue(this Win32_PerfRawData_PerfOS_Memory enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_PerfOS_Memory", enumOption.ToString());
	}
}