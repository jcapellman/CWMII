namespace CWMII.lib.Enums {
	public enum Win32_PerfFormattedData_SMSvcHost3000_SMSvcHost3000 {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfFormattedData_SMSvcHost3000_SMSvcHost3000Extension {
		public static string GetWMIValue(this Win32_PerfFormattedData_SMSvcHost3000_SMSvcHost3000 enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfFormattedData_SMSvcHost3000_SMSvcHost3000", enumOption.ToString());
	}
}