namespace CWMII.lib.Enums {
	public enum Win32_PerfRawData_Tcpip_IPv6 {
		Caption,
		Description,
		Name,
		Frequency_Object,
	...
	public static class Win32_PerfRawData_Tcpip_IPv6Extension {
		public static string GetWMIValue(this Win32_PerfRawData_Tcpip_IPv6 enumOption) => lib.CWMII.GetSingleProperty($"SELECT * FROM Win32_PerfRawData_Tcpip_IPv6", enumOption.ToString());
	}
}